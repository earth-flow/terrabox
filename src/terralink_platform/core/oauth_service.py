...
from ..core.utils.security import encrypt_token, decrypt_token
...
class OAuthService:
    ...
    def create_or_update_oauth_account(cls, db: Session, user_id: int, provider_name: str,
        ...
        if oauth_account:
            ...
            oauth_account.access_token = encrypt_token(token_data["access_token"])
            if "refresh_token" in token_data:
                oauth_account.refresh_token = encrypt_token(token_data["refresh_token"])
